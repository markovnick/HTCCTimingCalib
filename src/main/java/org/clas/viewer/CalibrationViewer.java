...
public final class CalibrationViewer implements IDataEventListener, ActionListener, DetectorListener, ChangeListener {
    ...
    private String workDir = "/Users/markovnick";
	...
	// create menu bar
        ...
        detectorView = new CCDetector("HTCC");
        initDetector();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getActionCommand()=="Open histograms file...") {
            ...
            File workingDirectory = new File(this.workDir + "/HTCCCalib-histos");
        ...
        if(e.getActionCommand()=="Save histograms...") {
            ...
            String fileName = "HTCCalib_" + this.runNumber + "_" + df.format(new Date()) + ".hipo";
            JFileChooser fc = new JFileChooser();
            File workingDirectory = new File(this.workDir + "/HTCCCalib-histos");
            fc.setCurrentDirectory(workingDirectory);
        ...
        if(e.getActionCommand()=="Save...") {
            DateFormat df = new SimpleDateFormat("MM-dd-yyyy_hh.mm.ss_aa");
            String dirName = "HTCCCalib_" + this.runNumber + "_" + df.format(new Date());
            JFileChooser fc = new JFileChooser();
            File workingDirectory = new File(this.workDir);
            fc.setCurrentDirectory(workingDirectory);
